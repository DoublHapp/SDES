...
### 第5关：封闭测试
根据第4关的结果，对于本实验的密码算法SDES，对于随机选择的一个明密文对，确实有不止一个密钥Key。如：  
![Test5_Image1](测试图片/test4.jpg)
进一步扩展，对应明文空间任意给定的明文分组，确实会出现选择不同的密钥加密得到相同密文的情况。如：   
![Test5_Image2](测试图片/test5_1.jpg)  
![Test5_Image3](测试图片/test5_2.jpg)  
